...
public class UnicodeFont extends FontRenderer {
   ...
   private static boolean isFormatSpecial(char formatChar) {
      return (formatChar >= 'k' ? true : false) & (formatChar <= 'o' ? true : false) | (formatChar >= 'K' ? true : false) & (formatChar <= 'O' ? true : false) | (formatChar == 'r' ? true : false) | (formatChar == 'R' ? true : false);
   }
            ...
            case '§':
               if (var5 < var3 - 1) {
                  ...
                  if (((var9 != 'l' ? 1 : 0) & (var9 != 'L' ? 1 : 0)) != 0) {
                     if ((var9 == 'r' || (var9 == 'R')) || isFormatColor(var9) != false) {
                        var7 = false;
                     }
                  } else {
                     var7 = true;
   ...
   private void setFont(Font font, boolean antiAlias, int charOffset) {
      synchronized (this) {
         ...
         this.boldFont = new IFont(font.deriveFont(1), antiAlias, charOffset);

         this.italicFont = new IFont(font.deriveFont(2), antiAlias, charOffset);

         this.boldItalicFont = new IFont(font.deriveFont(3), antiAlias, charOffset);
