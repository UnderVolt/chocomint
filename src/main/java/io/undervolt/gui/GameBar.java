...
public class GameBar extends Gui implements Listener {
    ...
    public void init(int width, int height, List<GuiButton> buttonList) {
        ...
        buttonList.add(this.notificationsButton = new TextureGameBarButton(
                1337101,
                width - 20, 0, 20, 20, "notifications"
        ));
        buttonList.add(this.userButton = new TextureGameBarButton(
                1337102,
                width - 48, 0, 20, 20,
        ...
        buttonList.add(this.changeMinecraftAccountButton = new TextureGameBarButton(
                1337107,
                width - 70, 0, 20, 20, "change"
        ));
        buttonList.add(this.musicButton = new TextureGameBarButton(
                1337103,
                width - 92, 0, 20, 20, "music"
        ));
        buttonList.add(this.friendsButton = new TextureGameBarButton(
                1337104,
                width - 114, 0, 20, 20, "friends"
        ));
        if(this.mc.theWorld != null && this.mc.thePlayer != null)
            buttonList.add(this.configButton = new GameBarButton(
                    1337106,
                    width - 136, 0, 20, 20, "C"
            ));
    }
