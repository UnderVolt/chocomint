...
public class DeclarativeMenu extends Screen {
    ...
    public DeclarativeMenu(final GuiScreen prev, final String menuName) {
        this(prev, menuName, MenuColor.DEFAULT, null);
    }

    public DeclarativeMenu(final GuiScreen prev, final String menuName, final MenuColor color) {
        this(prev, menuName, color, null);
    }

    public DeclarativeMenu(final GuiScreen prev, final String menuName, final MenuColor color, final String menuIcon) {
    ...
    public DeclarativeMenu(final GuiScreen prev, final String menuName, final String menuIcon) {
