...
public class CustomColors
{
    ...
    private static CustomColormap[][] readBlockColormaps(String[] basePaths, CustomColormap[] basePalettes, int width, int height)
    {
        ...
        Arrays.sort(astring);
        List<List<CustomColormap>> list = new ArrayList<List<CustomColormap>>();
    ...
    private static void addToList(CustomColormap p_addToList_0_, List<List<CustomColormap>> p_addToList_1_, int p_addToList_2_)
    {
    ...
    private static CustomColormap[][] blockListToArray(List<List<CustomColormap>> list)
    {
        ...
        {
            List<CustomColormap> list1 = list.get(i);

            if (list1 != null)
            {
                CustomColormap[] acustomcolormap1 = list1.toArray(new CustomColormap[list.size()]);
